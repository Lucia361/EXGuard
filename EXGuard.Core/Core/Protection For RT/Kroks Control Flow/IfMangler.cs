...
namespace EXGuard.Core.RTProtections.KroksCFlow
{
	public class IfMangler : ManglerBase
	{
		...
		LinkedList<Instruction[]> SpiltStatements(InstrBlock block, Trace trace, KroksContext ctx)
		{
		...
		public override void Mangle(CilBody body, ScopeBlock root, KroksContext ctx)
		{
			...
			body.MaxStack += 2;
			var predicate = new ExpressionPredicate(ctx);
