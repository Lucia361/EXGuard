...
namespace EXGuard.Core.CFG {
	public class BasicBlock<TContent> : IBasicBlock {
        ...
        IEnumerable<IBasicBlock> IBasicBlock.Sources => (IEnumerable<IBasicBlock>)Sources;
        IEnumerable<IBasicBlock> IBasicBlock.Targets => (IEnumerable<IBasicBlock>)Targets;
