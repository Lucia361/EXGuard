...
namespace EXGuard.Core.EXECProtections.CEXCFlow
{
	internal class SwitchMangler : ManglerBase
	{
		...
		LinkedList<Instruction[]> SpiltStatements(InstrBlock block, Trace trace, CEXContext ctx)
		{
		...
		public override void Mangle(CilBody body, ScopeBlock root, CEXContext ctx)
		{
