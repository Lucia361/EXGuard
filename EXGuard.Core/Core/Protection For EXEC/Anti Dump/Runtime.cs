...
{
    internal static class AntiDump_Runtime
	{
		[DllImport("kernel32.dll", SetLastError = true)]
	    static extern unsafe bool VirtualProtect(void* lpAddress, uint dwSize, uint flNewProtect, out uint lpflOldProtect);

		static unsafe void Initialize()
		{
			uint AnY;

			var module = typeof(AntiDump_Runtime).Module;
