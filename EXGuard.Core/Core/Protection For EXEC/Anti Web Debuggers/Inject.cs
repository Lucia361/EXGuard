...
{
    public static class AntiWebDebuggers_Inject
    {
        public static IList<MethodDef> Execute(ModuleDef module)
        {
            var typeDef = ModuleDefMD.Load(typeof(AntiWebDebuggers_Runtime).Module).ResolveTypeDef(MDToken.ToRID(typeof(AntiWebDebuggers_Runtime).MetadataToken));
