...
namespace EXGuard.Runtime.OpCodes {
	internal class SindByte : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SIND_BYTE; }
		}
	...
	internal class SindWord : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SIND_WORD; }
		}
	...
	internal class SindDword : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SIND_DWORD; }
		}
	...
	internal class SindQword : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SIND_QWORD; }
		}
	...
	internal class SindObject : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SIND_OBJECT; }
		}
	...
	internal class SindPtr : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SIND_PTR; }
		}
