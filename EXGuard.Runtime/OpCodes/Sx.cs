...
namespace EXGuard.Runtime.OpCodes {
	internal class SxDword : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SX_DWORD; }
		}
	...
	internal class SxWord : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SX_WORD; }
		}
	...
	internal class SxByte : IOpCode {
		public byte Code {
			get { return VMInstance.STATIC_Instance.Data.Constants.OP_SX_BYTE; }
		}
